...
(function(/*! Stitch !*/) {
  ...
  var MainRouter, PublicRouter;

  MainRouter = require('routers/main').MainRouter;

  PublicRouter = require('routers/public').PublicRouter;
...
}, "routers/main": function(exports, require, module) {(function() {
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  exports.MainRouter = (function() {
    ...
    MainRouter.prototype.init = function() {
      return this.navigate('secret', Backbone.history.getFragment() === '' ? true : void 0);
    };
    ...
    MainRouter.prototype.login = function() {
      ...
      $button.click(function(e) {
        ...
        return _this.navigate(Backbone.Login.from, true);
      });
      return $('#content').html($button);
    };

    MainRouter.prototype.secret = function() {
      var $button;
      var _this = this;
      $button = $('<button>continue to secret2</button>');
      $button.click(function(e) {
        return _this.navigate('secret2', true);
      });
      return $('#content').html($button);
    };

    MainRouter.prototype.secret2 = function() {
      return $('#content').html('secret2');
    };

    MainRouter.prototype.secretId = function(id) {
      return $('#content').html('secret with id: ' + id);
    };
...
}, "routers/public": function(exports, require, module) {(function() {
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  exports.PublicRouter = (function() {

    __extends(PublicRouter, Backbone.PublicRouter);

    function PublicRouter() {
      PublicRouter.__super__.constructor.apply(this, arguments);
    }
    ...
    PublicRouter.prototype.public = function() {
      return $('#content').html('public');
    };

    PublicRouter.prototype.pubId = function(id) {
      return $('#content').html('public with id: ' + id);
    };
